...
public class FCP_ClientThreadSPX extends Thread {

protected Socket sock;
protected InputStream in;
protected OutputStream out;

protected FCP_AcceptThreadSPX owner;
...
public FCP_ClientThreadSPX() { } //do nothing

public FCP_ClientThreadSPX(FCP_AcceptThreadSPX my_owner, Socket client_sock, int prmRemotePort)
{
	try {
		this.ready = false;
...
public boolean equals(FCP_ClientThreadSPX client)
{
